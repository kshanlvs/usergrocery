        ...
        body: 
         ...
         header: SliverToBoxAdapter(child: Padding(
           ...
           child: Column(
             ...
             children: [
               Text('What would you',style: TextStyle(color: textColor,fontSize: 26,fontWeight: FontWeight.bold),),
               Text("like to Order??",style: TextStyle(color: textColor,fontSize: 20,fontWeight: FontWeight.bold),),

               SizedBox(height:20),
               Text("All Products",style:TextStyle(color: Colors.grey,fontSize:18)),
